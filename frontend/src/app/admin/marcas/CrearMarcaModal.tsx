...
export default function CrearMarcaModal({ onClose, onSave }: CrearMarcaModalProps) {
  const { token } = useAuth();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError("Error al crear marca. Por favor intenta de nuevo.");
    }
    setLoading(false);
  };
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 p-6 text-white">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-2xl font-bold">Agregar Marca</h3>
            </div>
            <button
              onClick={onClose}
